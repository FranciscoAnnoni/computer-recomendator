...
- **Global scope**: `/Users/FranciscoAnnoni/Proyectos/computer-recomendator/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/FranciscoAnnoni/Proyectos/computer-recomendator/.claude/notes/`)
...
2. Glob `/Users/FranciscoAnnoni/Proyectos/computer-recomendator/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/FranciscoAnnoni/Proyectos/computer-recomendator/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/FranciscoAnnoni/Proyectos/computer-recomendator/.claude/notes/` — works in any directory
