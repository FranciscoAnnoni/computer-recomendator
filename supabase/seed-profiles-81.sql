...
-- Generated by scripts/curate_profiles.py --apply on Phase 13 (36 profiles).

UPDATE profiles SET laptop_ids = ARRAY['d8d84f9f-1dd4-40d5-8b18-5e51a66fa30c'::uuid, 'aa000022-0000-0000-0000-000000000022'::uuid, 'a96bb526-8bb4-47f8-bc78-83bda5899fbe'::uuid, 'a2bb2e6b-f8a4-4d0e-9db9-abaca12f7a48'::uuid, 'a677bf7c-ee7e-426d-901a-d6594672f963'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'equilibrado'
   AND os_preference = 'macos';

UPDATE profiles SET laptop_ids = ARRAY['a74b0d02-8635-499d-9c93-c6dea592059f'::uuid, 'aa000008-0000-0000-0000-000000000008'::uuid, 'd46d104c-e75c-4f8c-92ba-2c0f753af62b'::uuid, 'aa000007-0000-0000-0000-000000000007'::uuid, 'acac6672-641f-4b62-9fa4-cc167f3eed78'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'equilibrado'
...
UPDATE profiles SET laptop_ids = ARRAY['51cd723f-6440-4c65-b1e5-3f0870fb3b68'::uuid, 'f0668576-8519-4ce7-a02c-a041e808d49d'::uuid, 'd59625fc-5433-4a84-be02-d96c7ca09fe1'::uuid, 'c1d2d1f9-7be3-4759-9e3c-d4d1bfd25c8d'::uuid, '1633a121-1b2b-4a0f-9b4e-a2d75f5a84b0'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'esencial'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['e7443a6e-55b0-4731-8c0e-ab05242a83a1'::uuid, '6c4a3e95-9590-4375-8bb7-221cb88682e0'::uuid, 'cd8f5a83-4218-4fdc-b9d7-6665c1dfd39c'::uuid, '9cb88fc3-3438-46ad-9ff3-c1c4f0c75846'::uuid, '3879e975-a0d5-4d20-a516-cfa4fa50b129'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'premium'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['c3bb1a5f-560a-450d-b221-bf3b59fdb5e7'::uuid, '914da3c1-9cdf-4355-9c23-93289581f261'::uuid, '0e82bcd6-a83d-43d1-88a9-03d9f1a6cd19'::uuid, '0682b0e1-6aef-43ff-8150-688d6e2e82df'::uuid, '84322b86-6bc0-4e60-86a9-ce4f66c40ab9'::uuid]::uuid[]
 WHERE workload = 'gaming_rendimiento'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'equilibrado'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['d8d84f9f-1dd4-40d5-8b18-5e51a66fa30c'::uuid, 'aa000022-0000-0000-0000-000000000022'::uuid, '6bd3cfa5-5e24-43fe-85a5-8a4ede62342c'::uuid, '92ccdffe-f654-4095-93a4-06b856ee3b81'::uuid, 'bcda6661-806d-40ee-82c0-7e19fe3b4068'::uuid]::uuid[]
 WHERE workload = 'productividad_estudio'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'equilibrado'
   AND os_preference = 'macos';

UPDATE profiles SET laptop_ids = ARRAY['80fb8b8a-5067-4285-9e59-1cc6d9f0bc57'::uuid, '4d4c493c-1850-497b-92e0-bfd8c08edbdc'::uuid, 'b2f69884-0c42-404f-860b-fd3715b7559c'::uuid, 'a0733607-e04a-4213-899d-8348e3593105'::uuid, 'e6c21ac6-6803-42aa-9981-caead4ef8480'::uuid]::uuid[]
 WHERE workload = 'productividad_estudio'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'equilibrado'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['51cd723f-6440-4c65-b1e5-3f0870fb3b68'::uuid, 'f0668576-8519-4ce7-a02c-a041e808d49d'::uuid, 'd59625fc-5433-4a84-be02-d96c7ca09fe1'::uuid, 'c1d2d1f9-7be3-4759-9e3c-d4d1bfd25c8d'::uuid, 'a14cfd33-de29-4b01-8033-b9c857162a31'::uuid]::uuid[]
 WHERE workload = 'productividad_estudio'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'esencial'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['143cbd8b-173d-46d0-adf0-f59aefc26fdd'::uuid, '886ef4f6-7a5b-4061-8c6a-b0d15791efe0'::uuid, '9b860be0-c51e-4eb9-8c0d-fc7ec8c1c386'::uuid, '0fb2997b-5353-481d-8dcf-f5c5941e3b4e'::uuid, 'bdc35ae8-833d-4c21-8b9a-7c2898f8f58c'::uuid]::uuid[]
 WHERE workload = 'productividad_estudio'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'premium'
   AND os_preference = 'windows';
...
-- ─── Phase 13: laptop_ids assignments (auto-generated) ─────────
-- Generated by scripts/curate_profiles.py --apply on Phase 13 (fix: desktop exclusion + Apple pinning).
...
UPDATE profiles SET laptop_ids = ARRAY['e7443a6e-55b0-4731-8c0e-ab05242a83a1'::uuid, '3879e975-a0d5-4d20-a516-cfa4fa50b129'::uuid, '69793a15-95b7-45f6-ae35-37044c411ac3'::uuid, '6c4a3e95-9590-4375-8bb7-221cb88682e0'::uuid, 'cd8f5a83-4218-4fdc-b9d7-6665c1dfd39c'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'premium'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['a6b1908e-c637-44ef-820e-55618eb865c2'::uuid, 'e823e6a6-db30-4024-9a39-c12592059117'::uuid, 'a929e4a3-c272-4270-b26d-5864987d5538'::uuid, 'f3538eb6-1a67-47c7-938d-c5c71f0fa1e0'::uuid, '9f752bdc-43f3-48d5-8caa-180c7e1cc8cc'::uuid]::uuid[]
 WHERE workload = 'creacion_desarrollo'
   AND lifestyle = 'maxima_portabilidad'
   AND budget = 'equilibrado'
   AND os_preference = 'windows';
...
UPDATE profiles SET laptop_ids = ARRAY['bdc35ae8-833d-4c21-8b9a-7c2898f8f58c'::uuid, '143cbd8b-173d-46d0-adf0-f59aefc26fdd'::uuid, 'a8519721-0e17-45e7-8f8e-997df6234e57'::uuid, '266d1336-1fc2-4ba9-8cd5-ce71e7281b63'::uuid, '72f5af81-c86f-4910-a010-cab3df35e8b4'::uuid]::uuid[]
 WHERE workload = 'productividad_estudio'
   AND lifestyle = 'escritorio_fijo'
   AND budget = 'premium'
   AND os_preference = 'windows';
